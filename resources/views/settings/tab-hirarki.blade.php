<script src="https://cdn.jsdelivr.net/npm/gojs@3.0.26/release/go.js"></script>
    ...
    <script id="code">
        function init() {
                        ...
                        click: (e, button) => {
                            ...
                            if (node !== null) {
                                myDiagram.model.commit((m) => {
                                    ...
                                    while (chl.next()) {
                                        const emp = chl.value;
                                        m.setParentKeyForNodeData(emp.data, node.findTreeParentNode().data
                                            .key);
                                    }
            ...
            myDiagram.linkTemplate = new go.Link({
                ...
                strokeWidth: 2
            }).theme('stroke', 'link')); // the link shape
