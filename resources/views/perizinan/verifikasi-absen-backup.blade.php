...
@section('content')
    <style>
        ...
        .status-pulang-awal { background: #cce7ff; color: #004085; }
    </style>
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="card form-card">
                            <div class="form-header">
                                ...
                                <p class="mb-0 mt-2 opacity-75">Ajukan verifikasi untuk memperbaiki data kehadiran yang tidak sesuai</p>
                            </div>
                            <div class="card-body">
                                <form id="verifikasiForm" action="{{ url('perizinan/verifikasi-absen/store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    
                                    <!-- Informasi Karyawan -->
                                    <div class="row mb-4">
                                        <div class="col-12">
                                            <h5 class="text-success mb-3"><i class="fas fa-user mr-2"></i>Informasi Karyawan</h5>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-12">
                                            <h5 class="text-success mb-3"><i class="fas fa-calendar-check mr-2"></i>Detail Verifikasi</h5>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="tanggal_absen">Tanggal Absen <span class="required">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="mt-2" id="current-status">
                                                    <span class="attendance-status status-tidak-hadir">Tidak Ada Data</span>
                                                    <small class="text-muted d-block">Pilih tanggal untuk melihat status</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="mt-2">
                                                    <div class="verification-type" onclick="selectVerificationType('absen_masuk')">
                                                        <input type="radio" id="absen_masuk" name="jenis_verifikasi" value="absen_masuk" required>
                                                        <label for="absen_masuk" class="mb-0">
                                                            <strong>Verifikasi Absen Masuk</strong>
                                                            <br><small class="text-muted">Saya sudah hadir tetapi tidak tercatat absen masuk</small>
                                                        </label>
                                                    </div>
                                                    
                                                    <div class="verification-type" onclick="selectVerificationType('absen_pulang')">
                                                        <input type="radio" id="absen_pulang" name="jenis_verifikasi" value="absen_pulang">
                                                        <label for="absen_pulang" class="mb-0">
                                                            <strong>Verifikasi Absen Pulang</strong>
                                                            <br><small class="text-muted">Saya sudah pulang tetapi tidak tercatat absen pulang</small>
                                                        </label>
                                                    </div>
                                                    
                                                    <div class="verification-type" onclick="selectVerificationType('koreksi_waktu')">
                                                        <input type="radio" id="koreksi_waktu" name="jenis_verifikasi" value="koreksi_waktu">
                                                        <label for="koreksi_waktu" class="mb-0">
                                                            <strong>Koreksi Waktu Absen</strong>
                                                            <br><small class="text-muted">Waktu absen tercatat tidak sesuai dengan waktu sebenarnya</small>
                                                        </label>
                                                    </div>
                                                    
                                                    <div class="verification-type" onclick="selectVerificationType('absen_lengkap')">
                                                        <input type="radio" id="absen_lengkap" name="jenis_verifikasi" value="absen_lengkap">
                                                        <label for="absen_lengkap" class="mb-0">
                                                            <strong>Verifikasi Absen Lengkap</strong>
                                                            <br><small class="text-muted">Tidak ada catatan absen sama sekali padahal sudah hadir</small>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mb-4" id="time-correction-section" style="display: none;">
                                        <div class="col-12">
                                            <div class="time-input-group">
                                                <h6 class="text-success mb-3"><i class="fas fa-clock mr-2"></i>Waktu yang Benar</h6>
                                                <div class="row">
                                                    <div class="col-md-6" id="jam-masuk-section">
                                                        <div class="form-group">
                                                            <label for="jam_masuk_benar">Jam Masuk yang Benar</label>
                                                            <input type="time" class="form-control" id="jam_masuk_benar" name="jam_masuk_benar">
                                                            <small class="text-muted">Waktu sebenarnya saat masuk kerja</small>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6" id="jam-pulang-section">
                                                        <div class="form-group">
                                                            <label for="jam_pulang_benar">Jam Pulang yang Benar</label>
                                                            <input type="time" class="form-control" id="jam_pulang_benar" name="jam_pulang_benar">
                                                            <small class="text-muted">Waktu sebenarnya saat pulang kerja</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="alasan_verifikasi">Alasan/Penjelasan Verifikasi <span class="required">*</span></label>
                                                <textarea class="form-control" id="alasan_verifikasi" name="alasan_verifikasi" rows="4" 
                                                          placeholder="Jelaskan secara detail mengapa data absen perlu diverifikasi..." required></textarea>
                                                <small class="text-muted">
                                                    Contoh: "Saya sudah masuk kerja jam 08:00 tetapi lupa absen karena langsung meeting. Saya baru ingat absen saat jam istirahat."
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="saksi_nama" name="saksi_nama" 
                                                       placeholder="Nama rekan kerja yang dapat membuktikan">
                                                <small class="text-muted">Opsional, tetapi sangat membantu verifikasi</small>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="saksi_jabatan">Jabatan Saksi</label>
                                                <input type="text" class="form-control" id="saksi_jabatan" name="saksi_jabatan" 
                                                       placeholder="Jabatan saksi">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <small class="text-muted">Contoh: Kantor pusat, WFH, Meeting di client, dll.</small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="file-upload-area" onclick="document.getElementById('lampiran').click()">
                                                    <i class="fas fa-cloud-upload-alt fa-3x text-success mb-3"></i>
                                                    <h5>Klik untuk upload atau drag & drop file</h5>
                                                    <p class="text-muted mb-0">Format: PDF, JPG, PNG, DOC, DOCX (Max: 5MB)</p>
                                                    <input type="file" class="d-none" id="lampiran" name="lampiran[]" 
                                            ...
                                            <div class="alert alert-success">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="pernyataan">
                                                        <strong>Pernyataan:</strong> Saya menyatakan bahwa informasi yang saya berikan adalah benar dan dapat dipertanggungjawabkan. Saya memahami bahwa verifikasi absen yang tidak benar dapat berdampak pada penilaian kinerja dan tindakan disipliner.
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="info-card mb-3">
                                    ...
                                    <p class="mb-0 small">Pengajuan verifikasi maksimal 7 hari setelah tanggal absen yang bermasalah.</p>
                                </div>
                                
                                <div class="info-card mb-3">
                                    <h6 class="text-success"><i class="fas fa-search mr-2"></i>Proses Verifikasi</h6>
                                    <p class="mb-0 small">Tim HRD akan melakukan pengecekan CCTV, log sistem, dan konfirmasi dengan saksi jika ada.</p>
                                </div>
                                
                                <div class="info-card mb-3">
                                    <h6 class="text-success"><i class="fas fa-file-alt mr-2"></i>Bukti Pendukung</h6>
                                    <p class="mb-0 small">Semakin lengkap bukti yang dilampirkan, semakin cepat proses verifikasi.</p>
                                </div>
                                
                                <div class="info-card mb-3">
                                    <h6 class="text-success"><i class="fas fa-exclamation-triangle mr-2"></i>Penting</h6>
                                    <p class="mb-0 small">Verifikasi absen yang terbukti tidak benar dapat berakibat pada tindakan disipliner.</p>
                                </div>
                                
                                <div class="info-card">
                                    <h6 class="text-success"><i class="fas fa-phone mr-2"></i>Bantuan</h6>
                                    <p class="mb-0 small">Hubungi HRD (ext. 123) untuk bantuan pengisian form verifikasi.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            verificationTypes.forEach(type => {
                type.addEventListener('click', function() {
                    ...
                    if (value === 'absen_masuk' || value === 'absen_pulang' || value === 'koreksi_waktu' || value === 'absen_lengkap') {
